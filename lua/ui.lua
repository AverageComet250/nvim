vim.pack.add({
    ...
    "https://github.com/AverageComet250/modus-themes.nvim",
...
require('incline').setup {
  ...
  render = function(props)
    ...
    -- if #vim.api.nvim_list_wins() ~= 2 then return {
    -- if #vim.api.nvim_tabpage_list_wins(0) ~= 2 and #vim.api.nvim_tabpage_list_wins(0) ~= 1 then return {
    if count_text_windows() > 1 then return {
    -- return {
